    ...
    <div class="space-y-3">
        <div>
            <label for="bale-inline-add-on" class="block mb-2 text-sm font-medium dark:text-white">Website
                URL</label>
            <div class="relative">
                <input type="text" id="bale-inline-add-on" name="bale-inline-add-on"
                    class="py-3 px-4 ps-16 block w-full border-emerald-200 rounded-lg sm:text-sm focus:z-10 focus:border-emerald-500 focus:ring-emerald-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-700 dark:border-emerald-700 dark:text-white dark:placeholder-neutral-500 dark:focus:ring-emerald-600"
                    ...
                    <div class="grid gap-2 mt-4 select-none sm:grid-cols-2">
                        <label for="charsLower"
                            ...
                            <input type="checkbox" id="charsLower" x-ref="charsLower" x-model="charsLower"
                                @input="generatePassword()"
                                class="w-5 h-5 transition duration-200 text-emerald-400 form-checkbox rounded-xl focus:border-emerald-500 focus:ring-emerald-500"
                        ...
                        <label for="charsUpper"
                            class="flex w-full p-3 text-sm bg-white border border-gray-200 rounded-lg focus:border-emerald-400 focus:ring-emerald-400 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
